	...
	private class Accion_botones implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(e.getSource()==boton1){
				...
				JOptionPane.showMessageDialog(Lamina_Cuadros_Dialogos.this, "Mensaje de dialogo","Holaaaa",2);
			
            }else if(e.getSource()==boton2){

				JOptionPane.showInputDialog(Lamina_Cuadros_Dialogos.this,"Introduzca algo","Titulardo",1);

			}else if(e.getSource()==boton3){
				
                JOptionPane.showConfirmDialog(Lamina_Cuadros_Dialogos.this,"Esto es un titulo", "V confirmar", 0);
				
			}else{
				
				JOptionPane.showOptionDialog(Lamina_Cuadros_Dialogos.this, "Hola que tal","Esto es un titulo" , 1, 1, null, null, null);
			}
